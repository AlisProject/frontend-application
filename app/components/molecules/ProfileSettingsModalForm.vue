      ...
      <form class="signup-form" @submit.prevent>
        <div class="upload-img-section">
          <img
            ...
            alt="Profile image"
          >
          <img v-else-if="uploadedImage" class="upload-img" :src="uploadedImage" alt="Profile image">
          <img v-else src="~assets/images/pc/common/icon_user_noimg.png" class="upload-img" alt="Profile image">
